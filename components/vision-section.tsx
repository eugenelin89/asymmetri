          ...
          <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr]">
            ...
            <div className="space-y-6">
              <p className="text-base leading-8 text-slate-300 sm:text-lg">
                Much of modern AI still lives in digital environments. The next wave of capability
                will depend on systems that can perceive, adapt, coordinate, and act under
              ...
              <p className="text-base leading-8 text-slate-400 sm:text-lg">
                ...
                rigorous enough for physical deployment, extensible enough for future classes of
                autonomous systems, and ambitious enough to matter as Physical AI scales.
              </p>
