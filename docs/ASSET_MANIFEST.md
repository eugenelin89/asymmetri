...
| `public/images/research/systems-workbench.webp`         | Owner-supplied first-party portfolio | 1080×1440  | Unchanged; Story-page technical origin. Retained beside an explicit caption connecting hands-on engineering and physical experiments to testing ideas against the real world, rather than implying a sports product. | A workbench with small tracked robots, electronics, and prototyping tools.            | Previously public; presented as experimental practice, not a current sports product.          |
